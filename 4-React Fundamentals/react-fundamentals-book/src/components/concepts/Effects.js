            ...
            <div className="mainDiv">
                ...
                <ul>
                    <li> They are triggered with state and prop updates, as well as after
                         initial render to the DOM.</li>
                    <li>Effects are used to trigger certain actions based upon changes to 
                        the component.</li>
                    <li>Effects can return cleanup functions, which can clean up 
                        timers using memory, listeners to outside APIs, and other functions 
...
const SampleEffect=() => {
    ...
    useEffect(() => {
        console.log('timer timer bo bimer');
      }, [timerRunning]) 

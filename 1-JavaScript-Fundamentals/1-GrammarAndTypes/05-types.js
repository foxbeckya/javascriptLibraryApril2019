...
(because that's the gag). Undefined values are gifts given when the person giving the 
gift has forgotten to put the gift inside (oops!)
*/
...
Denoted by []
Have values ('blue', 'green', 'yellow'), separated by commas
*/
